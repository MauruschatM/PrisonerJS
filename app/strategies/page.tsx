    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-8">
        <h1 className="text-3xl font-bold mb-4">
          Prisoner's Dilemma Strategien
        </h1>
        <p className="text-gray-600 mb-6">
          Erstellen Sie Ihre eigenen Strategien für das Prisoner's Dilemma.
          Jeden Samstagabend werden alle aktiven Strategien in einem Tournament
        ...
        <Card className="mb-6">
          ...
          <CardBody>
            <div className="space-y-2">
              ...
              <p>
                <strong>Einer defektiert (D), einer kooperiert (C):</strong>{" "}
                Defektierer: 5 Punkte, Kooperierender: 0 Punkte
              </p>
              <p>
              ...
              <p className="text-sm text-gray-600">
                Ihre Strategie-Funktion erhält die Historie des Gegners, Ihre
                eigene Historie und die aktuelle Rundennummer. Sie muss "C"
                (Kooperieren) oder "D" (Defektieren) zurückgeben.
              </p>
            </div>
          </CardBody>
        </Card>
          ...
          <Card>
            <CardBody>
              <p className="text-center text-gray-600">
                Sie haben noch keine Strategien erstellt. Erstellen Sie Ihre
                erste Strategie!
              </p>
            </CardBody>
          </Card>
            ...
            <Card key={strategy.id}>
              <CardHeader className="flex justify-between items-start">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Switch
                    isSelected={strategy.isActive}
                    onChange={() => toggleActive(strategy)}
                  />
                </div>
              </CardHeader>
              <CardBody>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-gray-600">
                      ...
                      {strategy.updatedAt !== strategy.createdAt && (
                        <span>
                          {" "}
                          • Aktualisiert: {formatDate(strategy.updatedAt)}
                        </span>
                      )}
                    </div>
                    <Button
